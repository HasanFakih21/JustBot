    ...
    LazyLock::new(|| {
        ...
        for depth in 1..128 {
            for move_count in 1..64 {
                ...
                let ln_moves = f32::ln(move_count as f32);
                let base = 0.7844;

                quiet_table[depth][move_count] =
                    ((base + ln_depth * ln_moves / 2.4696) * 1024.0) as i32;
                noisy_table[depth][move_count] =
                    ((base + ln_depth * ln_moves / 3.0) * 1024.0) as i32;
            }
        }
